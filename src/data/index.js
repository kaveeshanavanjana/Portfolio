...
- Isala Vineth
    ...
    {
        id: 2,
        title: "TCP Multi-Client Real-Time Chat Application",
        description: "A Python-based real-time chat client with a modern GUI using CustomTkinter. It connects to a TCP server, supports multiple users, and displays messages in a scrollable chat area with bubbles. Background threads ensure instant sending and receiving of messages without freezing the interface.",
        techStack: ["Python", "CustomTkinter", "TCP/IP", "Threading"],
        link: "https://github.com/kaveeshanavanjana/Real-Time-chat-application",
